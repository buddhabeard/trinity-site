...
For last step it will have a create new pull request button associated with your branch name. 
Click on that then it's ready for review and merge to main, when approved
